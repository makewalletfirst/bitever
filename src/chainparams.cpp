...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 478560 + consensus.nMinerConfirmationWindow;
	...
	consensus.nForkHeight = 478559; //위에서 스탑하고 확인해야함
...
public:
    CTestNetParams() {
        ...
        consensus.SegwitHeight = 2000;  //2000block
        consensus.MinBIP9WarningHeight = 2000 + consensus.nMinerConfirmationWindow; // = 4016
        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 10 * 60;
